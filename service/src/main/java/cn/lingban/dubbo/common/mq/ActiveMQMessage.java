package cn.lingban.dubbo.common.mq;
...
public class ActiveMQMessage {
    ...
    public ActiveMQMessage(String username, String password, String tcp, String topic) {
    ...
    public void consumeMessage(MessageListener messageListener) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(this.username, this.password, this.tcp);
        try {
            // 构造从工厂得到连接对象
    ...
    public <T extends Serializable> void produceMessage(T obj) {
        ConnectionFactory connectionFactory;
        Connection connection = null;
        Session session;
        Destination destination;
